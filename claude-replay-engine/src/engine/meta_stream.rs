...
///
/// v10: modern Codex semantic event normalization (commands, edits, plans, web, lifecycle).
///
/// v11: structured command exploration plus tool execution status/exit/duration. Older durable
/// streams contain undifferentiated Bash blocks and no execution metadata, so they must refold.
///
