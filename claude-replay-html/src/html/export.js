...
(function () {
  ...
  var CLASSIC_INTERACTION = { card: "irq", icon: "irq-icon", copy: "irq-copy", meta: "irq-meta", answers: "irq-answers", answer: "irq-answer", question: "irq-question", reply: "irq-reply", preview: "irq-preview" };
